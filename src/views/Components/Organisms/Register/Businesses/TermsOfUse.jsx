...
const TermsOfUse = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            navigate("/businesses/create-account/enter-an-email");
        },
    });
                ...
                <div className="py-5">
                    <div className="mb-6">
                        <div className="flex items-center">
                            ...
                            <label htmlFor="trems" className="ml-2 text-base font-bold text-gray-900">I have read and agree to the <Link className={"text-sky-500 underline hover:no-underline"} to={"/terms"}>terms of use</Link> .</label>
                        </div>
