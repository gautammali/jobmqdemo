...
const TermsOfUse = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            navigate("/individuals/create-account/enter-an-email");
        },
    });
                ...
                <div className="py-5">
                    <div className="mb-6">
                        <div className="flex items-center">
                            ...
                            <label htmlFor="trems" className="ml-2 text-base font-bold text-gray-900">I have read and agree to the <NavLink className={"text-sky-500 underline hover:no-underline"} to={"/terms"}>terms of use</NavLink>.</label>
                        </div>
                    ...
                    <div className="mb-3">
                        <div className="flex items-center ">
                            <input
                                ...
                                onChange={formik.handleChange}
                                className="w-6 h-6 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500" />
                            <label htmlFor="privacy" className="ml-2 text-base font-bold text-gray-900">I have read and understand the  <Link className={"text-sky-500 underline hover:no-underline"} to={"/privacy"}>privacy notice</Link>.</label>
                        </div>
