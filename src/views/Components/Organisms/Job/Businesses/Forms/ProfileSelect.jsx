...
import { useGetCityValuesQuery, useUpdateJobKeywordMutation } from '../../../../../../features/keyword/keywordApi'
// import Warning from '../../../../Atoms/Alert/Warning'

export default function ProfileSelect({ setOpen, item, lineNo, prevItem }) {
    ...
    const prevData = data?.data?.find(i => i.valueID == item.kwid)
    ...
    return !isSuccess ? <p className='capitalize -mt-8 text-rose-500 font-bold'> Please select category before</p> : (
        <Formik
