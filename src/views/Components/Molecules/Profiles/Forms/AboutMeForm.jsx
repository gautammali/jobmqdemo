...
export default function AboutMeForm({ setOpen, prevData }) {
  ...
  return (
    ...
    >

      {
        formik => (
          <Form>
            <h3 className='text-[#051532] text-2xl mb-2 font-medium'>Edit about me</h3>
            ...
            <div className="sp space-y-4 py-5">
              ...
              <FormikControl control="textarea" label="Write a short summary about yourself (optional)" name="aboutUs" left={<Leftword max={3000} current={formik.values.aboutUs} />} />


              <FormikControl control="input" label="Designation" name="designation" />

              <FormikControl control="inputLink" type="text" label="Your linkedIn profile (optional)" name="linkedInProfile" pre="https://www.linked.com/in/" />

        

              <FormikControl control="input" type="text" label="Video of your personal introduction (optional)" name="youTubeProfileUrl" />
